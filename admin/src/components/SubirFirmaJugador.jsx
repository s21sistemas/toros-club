...
export const SubirFirmaJugador = () => {
  const { sigCanvasJugador, clearSignatureJugador, saveSignatureJugador } =
    useSignature()

  return (
    <div>
      <SignatureCanvas
        ref={sigCanvasJugador}
        canvasProps={{
