                ...
                <table role="presentation" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; margin: 0 auto; background-color: #ffffff;">
                    <tr>
                        <td style="padding: 30px 25px;">
                            ...
                            <p style="line-height: 1.6; margin-bottom: 25px; font-size: 16px;">Gracias por ser parte del panel administrativo del Club Toros. Hemos guardado sus datos correctamente y estamos emocionados de tenerle con nosotros. A continuación, encontrará un resumen de la información proporcionada:</p>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse; margin: 30px 0;">
                                <tr>
                                    <td style="text-align: center;">
                                        <a href="https://admin.clubtoros.com/" class="button-login" style="color: #ffffff">Iniciar sesión</a>
                                    </td>
                                </tr>
                            </table>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; margin: 0 auto; background-color: #333333; border-radius: 0 0 8px 8px;">
                    <tr>
                        <td style="padding: 20px; text-align: center; color: #ffffff;">
                            ...
                            <p style="margin: 5px 0 0 0; font-size: 12px;">Teléfono: <a href="tel:8180507808" class="info-a" style="color: #ffffff">81 8050 7808</a></p>
                        </td>
                    </tr>
                </table>
